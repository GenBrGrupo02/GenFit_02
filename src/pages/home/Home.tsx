        ...
        <>
            ...
            <div className="">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mt-2 p-20">
                    ...
                    {/* Hector */}
                    <div className="flex flex-col items-center rounded-xl bg-base-300">
                        <img className="h-100 object-cover rounded-xl mt-10 mb-4" src="https://i.ibb.co/VjsNm9P/hec.png" alt="Hector Silva" />
                        <h2 className="text-xl font-semibold mb-2">Hector</h2>
                        <p className="text-md text-primary mb-4">Diretor</p>
                        <p className="text-base-content text-center mb-4 ml-4 mr-4">
                    ...
                    <div className="flex flex-col items-center rounded-xl bg-base-300">
                        ...
                        <h2 className="text-xl font-semibold mb-2">Lucas</h2>
                        <p className="text-md text-primary mb-4">Atendimento ao cliente </p>
                        <p className="text-base text-center text-base-content mb-4 ml-4 mr-4">
                    ...
                    <div className="flex flex-col items-center rounded-xl bg-base-300">
                        ...
                        <h2 className="text-xl font-semibold mb-2">Pedro</h2>
                        <p className="text-md text-primary mb-4">Coach de performance</p>
                        <p className="text-base text-center text-base-content mb-4 ml-4 mr-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mb-20 mt-2 p-20">
                    ...
                    <div className="flex flex-col items-center rounded-xl bg-base-300">
                        ...
                        <h2 className="text-xl font-semibold mb-2">Michele</h2>
                        <p className="text-md text-primary mb-4">Instrutora FitDance</p>
                        <p className="text-base text-center text-base-content mb-4 ml-4 mr-4">
                    ...
                    <div className="flex flex-col items-center rounded-xl bg-base-300">
                        ...
                        <h2 className="text-xl font-semibold mb-2">Bruna</h2>
                        <p className="text-md text-primary mb-4">Instrutora</p>
                        <p className="text-base text-center text-base-content mb-4 ml-4 mr-4">
            ...
            <div className="hero bg-base-100 flex justify-between items-center max-lg:flex-col gap-10 w-full max-container p-16 min-h-screen">
                <div className="flex flex-1 flex-col max-w-lg">
                    <h2 className="ml-20 text-4xl font-bold mb-4">GenFit <br /> <span className="text-info">Nossa missão</span></h2>
                    <br />
                    <p className="text-lg text-base-content ml-20">
