...
function CardObjetivosInstrutor({ objetivo }: CardObjetivosProps) {
  return (
    <>
      ...
      <div className="bg-base-200 collapse">
        ...
        <div className="font-body collapse-content bg-primary text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content">
          <p>{objetivo.descricao}</p>
          <div className="flex">
            <Link
              to={`/editarobjetivo/${objetivo.id}`}
...
export default CardObjetivosInstrutor;
