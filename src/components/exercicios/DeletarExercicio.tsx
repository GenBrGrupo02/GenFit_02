  ...
  return (
    <>
      ...
      <div className="container w-1/3 mx-auto">
        <h1 className="font-body text-4xl text-center my-4">
          Deletar objetivo
        </h1>
        <p className="font-body text-center font-semibold mb-4">
          Você tem certeza de que deseja apagar o objetivo a seguir?
        </p>
        <div className="border flex flex-col rounded-2xl overflow-hidden justify-between">
          <header className="font-title py-2 px-6 bg-primary text-white font-bold text-2xl">
            Objetivo
          </header>
