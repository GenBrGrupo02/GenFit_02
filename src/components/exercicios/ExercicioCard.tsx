    ...
    return (
        <div className="card w-96 bg-base-100 shadow-xl my-4">
            <div className="card-body">
                ...
                {exercicio.objetivo && <p className="mt-2"><span className="font-semibold">Objetivo:</span> {exercicio.objetivo?.descricao}</p>}
                <p className="mt-2"><span className="font-semibold">Dificuldade:</span> {exercicio.dificuldade}</p>
                {exercicio.videoTutorial && (
                    <p className="mt-2">
                        <span className="font-semibold">Video Tutorial:</span> 
                        <a href={exercicio.videoTutorial} target="_blank" rel="noopener noreferrer" className="text-indigo-400">Assistir</a>
                    </p>
                )}
            </div>
            <div className="card-actions justify-between p-4">
                ...
                <Link to=""
                    className="btn btn-error w-1/2 hover:bg-red-600">
                    Deletar
                </Link>
            </div>
        </div>
